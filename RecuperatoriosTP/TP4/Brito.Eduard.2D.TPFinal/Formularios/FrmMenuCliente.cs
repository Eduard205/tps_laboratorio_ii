    ...
    public partial class FrmMenuCliente : Form
    {
        ...
        private void BtnAgregarCliente_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    if (int.TryParse(TxtDni.Text, out dni) && dni.ValidarDni() && int.TryParse(TxtEdad.Text, out edad) &&
            ...
            {
                throw new Exception("Fallo al agregar al cliente");
            }
        }
        ...
        private void BtnAltaCliente_Click(object sender, EventArgs e)
        {
            ...
            catch (ErrorCargaDeDatosException)
            {
